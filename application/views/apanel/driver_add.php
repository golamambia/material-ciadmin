            ...
            <div class="row">
              <div class="col s10 m6 l6">
                ...
                <ol class="breadcrumbs mb-0" >
                  ...
                  <li class="breadcrumb-item active">add mode
                  </li>
                </ol>
              </div>
              <div class="col s2 m6 l6"><a class="btn  waves-effect waves-light breadcrumbs-btn right " href="<?=base_url();?>apanel/restaurant_driver/add"><i class="material-icons hide-on-med-and-up">settings</i><span class="hide-on-small-onl">Add user</span></a>
    ...
    <div class="col s12 m12 l12">
      <div id="Form-advance" class="card card card-default scrollspy">
        <div class="card-content">
          ...
          <form action="<?=base_url();?>apanel/user/user_edit_post/" method="post">
            <!-- <div class="row">
            ...
            <div class="row">
              <div class="input-field col s12">
                <input id="password6" name="name" type="text" value="" required>
            ...
            <div class="row">
              <div class="input-field col m6 s12">
                <input id="email5" type="email" value="" >
