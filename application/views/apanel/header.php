...
<head>
    ...
    <!-- <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>app-assets/css/themes/vertical-menu-nav-dark-template/materialize.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>app-assets/css/themes/vertical-menu-nav-dark-template/style.min.css"> -->
    <!-- END: Page Level CSS-->
    <!-- BEGIN: Custom CSS-->
  ...
  <link rel="stylesheet" href="https://www.jquery-az.com/javascript/alert/dist/alertify.default.css" id="toggleCSS" />
  ...
  <body class="vertical-layout vertical-menu-collapsible page-header-dark vertical-modern-menu preload-transitions 2-columns   " data-open="click" data-menu="vertical-modern-menu" data-col="2-columns">
    ...
    <header class="page-topbar" id="header">
      <div class="navbar navbar-fixed"> 
        <nav class="navbar-main navbar-color nav-collapsible sideNav-lock  <?php if($color_get[0]->tc_nav_dark!=0){echo'navbar-dark';}else{echo $color_get[0]->tc_nav_color;}?> no-shadow">
          <div class="nav-wrapper">
            ...
            <!-- <ul class="dropdown-content" id="translation-dropdown">
              <li class="dropdown-item"><a class="grey-text text-darken-1" href="#!" data-language="en"><i class="flag-icon flag-icon-gb"></i> English1</a></li>
            ...
            <ul class="dropdown-content" id="profile-dropdown">
              <li><a class="grey-text text-darken-1" href="<?php echo base_url() ?>apanel/settings/profile"><i class="material-icons">person_outline</i> Profile</a></li>
              
              <li class="divider"></li>
              <li><a class="grey-text text-darken-1" href="<?php echo base_url() ?>apanel/settings/change_password"><i class="material-icons">lock_outline</i> Password</a></li>
              <li class="divider"></li>
              <li><a class="grey-text text-darken-1" href="<?php echo base_url();?>apanel/home/logout"><i class="material-icons">keyboard_tab</i> Logout</a></li>
            </ul>
          </div>
